...
public class Resistor {
     ...
     */
    public Resistor(double resistance) { //constructor
        //Set values of state variables
        resistor_val = resistance;
        voltage_val = 0.0;
    }
    /**
     ...
     */
    public double getResistance() { //getter for resistance
     ...
     * @return the voltage
     */
    public double getVoltage() { //getter for volt
     ...
     */
    public void setVoltage(double voltage) { //setter
    ...
    public double getCurrent() {
        //FIX THIS
        return voltage_val / resistor_val;
    }
    ...
    public void setCurrent(double current) {
        ...
        if (current >= -5 && current <= 5) {
            voltage_val = current * resistor_val;
        } else {
    ...
    public double getPower() {
        //FIX THIS
        return (voltage_val * voltage_val) / resistor_val;
    }
